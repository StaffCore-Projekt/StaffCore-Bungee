...
public class SessionLengthCalculator {
	
	public static String calculate(long sessionstart, long sessionend) {
		
		long millis = sessionend - sessionstart;
		...
		if (tage != 0L) {
			return "§a" + strtage + "§7:§a" + strstunden + "§7:§a" + strminuten + "§7 " + Main.getMSG("Messages.Layouts.Ban.Remaining.Minutes");
		}
		if ((tage == 0L) && (stunden != 0L)) {
			return "§a" + strstunden + "§7:§a" + strminuten + "§7:§a" + strsekunden + "§7 " + Main.getMSG("Messages.Layouts.Ban.Remaining.Seconds");
		}
		if ((tage == 0L) && (stunden == 0L) && (minuten != 0L)) {
			return "§a" + strminuten + "§7:§a" + strsekunden + " §7"+ Main.getMSG("Messages.Layouts.Ban.Remaining.Seconds");
		}
