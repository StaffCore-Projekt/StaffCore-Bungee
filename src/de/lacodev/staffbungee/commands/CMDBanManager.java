				...
				if(args.length >= 4) {
					...
					if(args[0].equalsIgnoreCase("addreason")) {
						...
						if(player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) || player.hasPermission(Main.getPermissionNotice("Permissions.BanManager.addreason"))) {
				            ...
				            if(timeunit.equalsIgnoreCase("d") || timeunit.equalsIgnoreCase("h") || timeunit.equalsIgnoreCase("m") || args[2].equalsIgnoreCase("perma")) {
				            	...
				            	if(!ReasonManager.existsReason(ReasonType.valueOf(args[1].toUpperCase()), reason)) {
				            		...
				            		if(args[2].equalsIgnoreCase("perma")) {
					            		...
					            		player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.BanManager.Add-Reason.Success")));
					            		
					            	} else {
					            		
					            		ReasonManager.addReason(ReasonType.valueOf(args[1].toUpperCase()), reason, timeunit, Integer.valueOf(args[2].substring(0, args[2].length() - 1)));
					            		player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.BanManager.Add-Reason.Success")));
					            		
					            	}
				            		
				            	} else {
				            		player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.BanManager.Add-Reason.Already-Existing")));
				            	}
				            	
				            }
							
						} else {
							player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.System.No-Permission").replace("%permission%", Main.getPermissionNotice("Permissions.BanManager.addreason"))));
						}
						...
						if(player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) || player.hasPermission(Main.getPermissionNotice("Permissions.BanManager.removereason"))) {
							try {
								...
								if(reason != null) {
									...
									player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.BanManager.Remove-Reason.Success")));
									
								} else {
									player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.BanManager.Remove-Reason.Not-Exists")));
								}
							...
							player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.System.No-Permission").replace("%permission%", Main.getPermissionNotice("Permissions.BanManager.removereason"))));
						}
					...
					if(args[0].equalsIgnoreCase("listreasons")) {
						...
						if(player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) || player.hasPermission(Main.getPermissionNotice("Permissions.BanManager.listreasons"))) {
							...
							player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.System.No-Permission").replace("%permission%", Main.getPermissionNotice("Permissions.BanManager.listreasons"))));
						}
