								...
								try {
									...
									if(PlayerManager.getPunishment(id) != null) {
										...
										if(!punish.isUnbanned()) {
											...
											SimpleDateFormat last_login_format1 = new SimpleDateFormat(Main.getInstance().getConfig().getString("General.Time-Format"));
											...
											if(punish.getType().equals(PunishmentType.BAN)) {
												...
												player.sendMessage(new TextComponent(Main.getPrefix() + "§7Date of Unban §8» §c" + loginLastDate1));
												player.sendMessage(new TextComponent(Main.getPrefix() + "§7Unbanned by §8» §c" + punish.getUnbanstaff()));
												player.sendMessage(new TextComponent(Main.getPrefix() + "§7Unban-Reason §8» §c" + punish.getUnbanreason()));
											} else if(punish.getType().equals(PunishmentType.MUTE)) {
												player.sendMessage(new TextComponent(Main.getPrefix() + "§7Status §8» §cUNMUTED"));
												player.sendMessage(new TextComponent(Main.getPrefix() + "§7Date of Unmute §8» §c" + loginLastDate1));
												player.sendMessage(new TextComponent(Main.getPrefix() + "§7Unmuted by §8» §c" + punish.getUnbanstaff()));
												player.sendMessage(new TextComponent(Main.getPrefix() + "§7Unmute-Reason §8» §c" + punish.getUnbanreason()));
											}
