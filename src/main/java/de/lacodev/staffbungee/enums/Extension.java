...
public enum Extension {
    ...
    HOOK(""), PLUGIN_MANAGER("SC-EX-PluginManager"), TWOFA_AUTHENTICATION("SC-EX-2FA-Authenticator"), ANTICHEAT_HOOK("SC-EX-AntiCheatHook"),
    GUIS("SC-EX-GUI"), REWARDS("SC-EX-Rewards"), TASKS("SC-EX-Tasks");
