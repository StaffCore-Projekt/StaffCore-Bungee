            ...
            if (Main.getMySQL().isConnected()) {
                ...
                if (args.length == 0) {
                    ...
                    if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                        player.hasPermission(Main.getPermissionNotice("Permissions.ReportManager.addreason"))) {
                        player.sendMessage(new TextComponent(Main.getPrefix() + ChatColor.GRAY +
                            "/reportmanager addreason <Reason>"));
                    }
                    if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                        player.hasPermission(Main.getPermissionNotice("Permissions.ReportManager.removereason"))) {
                        player.sendMessage(new TextComponent(Main.getPrefix() + ChatColor.GRAY +
                            "/reportmanager removereason <ReasonID>"));
                    }
                    if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                        player.hasPermission(Main.getPermissionNotice("Permissions.ReportManager.listreasons"))) {
                        player.sendMessage(new TextComponent(Main.getPrefix() + ChatColor.GRAY +
                    ...
                    if (args[0].equalsIgnoreCase("listreasons")) {
                        ...
                        if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                            ...
                            player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.System.No-Permission")
                                .replace("%permission%", Main.getPermissionNotice("Permissions.ReportManager.listreasons"))));
                        }
                    ...
                    if (args[0].equalsIgnoreCase("addreason")) {
                        ...
                        if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                            ...
                            if (!ReasonManager.existsReason(ReasonType.REPORT, args[1])) {
                                ...
                                player.sendMessage(
                                    new TextComponent(Main.getPrefix() + Main.getMSG("Messages.ReportManager.Add-Reason.Success")));

                            } else {
                                player.sendMessage(
                                    new TextComponent(Main.getPrefix() + Main.getMSG("Messages.ReportManager.Add-Reason.Already-Exists")));
                            }

                        } else {
                            player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.System.No-Permission")
                                .replace("%permission%", Main.getPermissionNotice("Permissions.ReportManager.addreason"))));
                        }
                        ...
                        if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                            ...
                            try {
                                ...
                                if (reason != null) {
                                    ...
                                    player.sendMessage(
                                        new TextComponent(Main.getPrefix() + Main.getMSG("Messages.ReportManager.Remove-Reason.Success")));

                                } else {
                                    player.sendMessage(new TextComponent(
                                        Main.getPrefix() + Main.getMSG("Messages.ReportManager.Remove-Reason.Not-Exists")));
                                }
                            ...
                            player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.System.No-Permission")
                                .replace("%permission%", Main.getPermissionNotice("Permissions.ReportManager.removereason"))));
                        }
                ...
                if (args[0].equalsIgnoreCase("addreason")) {
                    ...
                    try {
                        ...
                        if (reason != null) {
                            ...
                            player.sendMessage(
                                new TextComponent(Main.getPrefix() + Main.getMSG("Messages.ReportManager.Remove-Reason.Not-Exists")));
                        }
