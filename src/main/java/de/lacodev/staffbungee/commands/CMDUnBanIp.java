    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (sender instanceof ProxiedPlayer) {
            ...
            if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                player.hasPermission(Main.getPermissionNotice("Permissions.IpUnBan.Use"))) {
                    ...
                    if (uuid != null) {
                        ...
                        if (BanManager.isIpBanned(PlayerManager.getLastKnownIp(uuid))) {
                            ...
                            player.sendMessage(new TextComponent(
                                Main.getPrefix() + Main.getMSG("Messages.Ban-System.IP-UnBan.Not-banned").replace("%target%", args[0])));
                        }
