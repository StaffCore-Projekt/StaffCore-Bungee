        ...
        if (sender instanceof ProxiedPlayer) {
            ...
            if (Main.getMySQL().isConnected()) {
                ...
                if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                    player.hasPermission(Main.getPermissionNotice("Permissions.Mute.Use"))) {
                    ...
                    if (args.length == 2) {
                        ...
                        if (PlayerManager.getUUIDByName(args[0]) != null) {
                            ...
                            if (!MuteManager.isMuted(uuid)) {
                                ...
                                if (!player.getUniqueId().toString().matches(uuid)) {
                                        ...
                                        if (ReasonManager.getReasonById(ReasonType.MUTE, id) != null) {
                                            ...
                                            if (Main.getInstance().getConfig().getBoolean("Per-Reason-Permission.Enable")) {
                                                ...
                                                if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                                                    ...
                                                    MuteManager.mute(uuid, ReasonManager.getReasonById(ReasonType.MUTE, id).getName(),
                                                        player.getUniqueId().toString());
                                                    player.sendMessage(
                                                        new TextComponent(Main.getPrefix() + Main.getMSG("Messages.Mute-System.Created")));
                                            ...
                                            player.sendMessage(new TextComponent(
                                                Main.getPrefix() + Main.getMSG("Messages.Mute-System.Reason-Not-Exists")));
                                        }
                                    ...
                                    player.sendMessage(
                                        new TextComponent(Main.getPrefix() + Main.getMSG("Messages.Mute-System.Cannot-mute-self")));
                                }
                        ...
                        if (args[2].equalsIgnoreCase("-s")) {
                            ...
                            if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                                player.hasPermission(Main.getPermissionNotice("Permissions.Mute.Silent"))) {
                                ...
                                if (PlayerManager.getUUIDByName(args[0]) != null) {
                                    ...
                                    if (!MuteManager.isMuted(uuid)) {
                                                ...
                                                if (ReasonManager.getReasonById(ReasonType.MUTE, id) != null) {
                                                    ...
                                                    if (Main.getInstance().getConfig().getBoolean("Per-Reason-Permission.Enable")) {
                                                        ...
                                                        if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                                                            ...
                                                            MuteManager.silentmute(uuid,
                                                                ReasonManager.getReasonById(ReasonType.MUTE, id).getName(),
                                                                player.getUniqueId().toString());
                                                            player.sendMessage(new TextComponent(
                                                                Main.getPrefix() + Main.getMSG("Messages.Mute-System.Created")));
                                        ...
                                        player.sendMessage(
                                            new TextComponent(Main.getPrefix() + Main.getMSG("Messages.Mute-System.Already-Muted")));
                                    }
                                ...
                                player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.System.No-Permission")
                                    .replace("%permission%", Main.getPermissionNotice("Permissions.Mute.Silent"))));
                            }
                    ...
                    player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.System.No-Permission")
                        .replace("%permission%", Main.getPermissionNotice("Permissions.Mute.Use"))));
                }
                    ...
                    if (!MuteManager.isMuted(uuid)) {
                        ...
                        try {
                            ...
                            if (ReasonManager.getReasonById(ReasonType.MUTE, id) != null) {
                                ...
                                player.sendMessage(
                                    new TextComponent(Main.getPrefix() + Main.getMSG("Messages.Mute-System.Reason-Not-Exists")));
                            }
