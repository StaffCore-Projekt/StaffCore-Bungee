        ...
        if (sender instanceof ProxiedPlayer) {
            ...
            if (Main.getMySQL().isConnected()) {
                ...
                if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                    player.hasPermission(Main.getPermissionNotice("Permissions.Ban.Use"))) {
                    ...
                    if (args.length == 2) {
                                ...
                                if (!player.getUniqueId().toString().matches(uuid)) {
                                    ...
                                    try {
                                        ...
                                        if (ReasonManager.getReasonById(ReasonType.BAN, id) != null) {
                                            ...
                                            if (Main.getInstance().getConfig().getBoolean("Per-Reason-Permission.Enable")) {
                                                ...
                                                if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                                                    player.hasPermission(
                                                        Main.getInstance().getConfig().getString("Per-Reason-Permission.Prefix") + id)) {

                                                    BanManager.ban(uuid, ReasonManager.getReasonById(ReasonType.BAN, id).getName(),
                                                        player.getUniqueId().toString());
                                                    player.sendMessage(
                                                        new TextComponent(Main.getPrefix() + Main.getMSG("Messages.Ban-System.Created")));

                                                } else {
                                                    player.sendMessage(new TextComponent(Main.getPrefix() +
                                                        Main.getMSG("Messages.System.No-Permission").replace("%permission%",
                                                            Main.getInstance().getConfig().getString("Per-Reason-Permission.Prefix") +
                                                                id)));
                                                }
                                            ...
                                            player.sendMessage(
                                                new TextComponent(Main.getPrefix() + Main.getMSG("Messages.Ban-System.Reason-Not-Exists")));
                                        }

                                    } catch (NumberFormatException e) {
                                        player.sendMessage(
                                            new TextComponent(Main.getPrefix() + Main.getMSG("Messages.Ban-System.NotValidID")));
                                    }

                                } else {
                                    player.sendMessage(
                                        new TextComponent(Main.getPrefix() + Main.getMSG("Messages.Ban-System.Cannot-ban-self")));
                                }
                        ...
                        if (args[2].equalsIgnoreCase("-s")) {
                            ...
                            if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                                player.hasPermission(Main.getPermissionNotice("Permissions.Ban.Silent"))) {
                                if (PlayerManager.getUUIDByName(args[0]) != null) {
                                    ...
                                    if (!BanManager.isBanned(uuid)) {
                                                ...
                                                if (ReasonManager.getReasonById(ReasonType.BAN, id) != null) {
                                                    ...
                                                    if (Main.getInstance().getConfig().getBoolean("Per-Reason-Permission.Enable")) {
                                                        ...
                                                        if (player.hasPermission(Main.getPermissionNotice("Permissions.Everything")) ||
                                                            ...
                                                            BanManager.silentban(uuid,
                                                                ReasonManager.getReasonById(ReasonType.BAN, id).getName(),
                                                                player.getUniqueId().toString());
                                                            player.sendMessage(new TextComponent(
                                                                Main.getPrefix() + Main.getMSG("Messages.Ban-System.Created")));

                                                        } else {
                                                            player.sendMessage(new TextComponent(Main.getPrefix() +
                                                                Main.getMSG("Messages.System.No-Permission").replace("%permission%",
                                                                    Main.getInstance().getConfig()
                                                                        .getString("Per-Reason-Permission.Prefix") + id)));
                                                        }
                                                    ...
                                                    player.sendMessage(new TextComponent(
                                                        Main.getPrefix() + Main.getMSG("Messages.Ban-System.Reason-Not-Exists")));
                                                }
                                        ...
                                        player.sendMessage(
                                            new TextComponent(Main.getPrefix() + Main.getMSG("Messages.Ban-System.Already-Banned")));
                                    }

                                } else {
                                    player.sendMessage(
                                        new TextComponent(Main.getPrefix() + Main.getMSG("Messages.Ban-System.Cannot-find-player")));
                                }
                            } else {
                                player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.System.No-Permission")
                                    .replace("%permission%", Main.getPermissionNotice("Permissions.Ban.Silent"))));
                            }
                        ...
                        if (uuid != null) {
                            ...
                            if (Main.getInstance().getConfig().getBoolean("ViolationLevelSystem.Enable")) {
                                player.sendMessage(new TextComponent(
                                    Main.getPrefix() + "§c" + args[0] + "§8(§c" + ViolationLevelHandler.getVL(uuid) + "§8)"));
                            }
                    ...
                    player.sendMessage(new TextComponent(Main.getPrefix() + Main.getMSG("Messages.System.No-Permission")
                        .replace("%permission%", Main.getPermissionNotice("Permissions.Ban.Use"))));
                }
            ...
            if (args.length == 2) {
                ...
                if (args[2].equalsIgnoreCase("-s")) {
                    ...
                    if (!reasons.isEmpty()) {
                        ...
                        for (Reason reason : reasons) {
                            player.sendMessage(new TextComponent(
                                "§8- §c" + reason.getType().toString() + " §8| §7#" + reason.getId() + " §e" + reason.getName() + " §8| " +
                                    ReasonLengthCalculator.calculate(reason.getLength())));
                        }
                        player.sendMessage(new TextComponent(""));
