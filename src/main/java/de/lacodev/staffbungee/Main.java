        ...
        if (getMySQL().isConnected()) {
            ...
            try {
                ...
                Main.getInstance().getProxy().getConsole()
                    .sendMessage(new TextComponent("§cSystem §8» §8Settings §asuccessfully §8loaded!"));
...
//			}
            ...
            Main.getInstance().getProxy().getConsole().sendMessage(new TextComponent(""));
            Main.getInstance().getProxy().getConsole()
                .sendMessage(new TextComponent("§cSystem §8» Environment: §7" + ProxyServer.getInstance().getVersion()));
            Main.getInstance().getProxy().getConsole()
                .sendMessage(new TextComponent("§cSystem §8» StaffCore: §7v" + this.getDescription().getVersion() + getPluginUpdate()));
            ...
            Main.getInstance().getProxy().getConsole()
                .sendMessage(new TextComponent("§cSystem §8» Environment: §7" + ProxyServer.getInstance().getVersion()));
            Main.getInstance().getProxy().getConsole()
                .sendMessage(new TextComponent("§cSystem §8» StaffCore: §7v" + this.getDescription().getVersion()));
    ...
    private void checkForUpdates() {
        ...
        new UpdateChecker(this, 93533).getLatestVersion(version -> {
            if (this.getDescription().getVersion().equalsIgnoreCase(version)) {
                ...
                Main.getInstance().getProxy().getConsole()
                    .sendMessage(new TextComponent("§cSystem §8» §7You are using the §alatest build§7!"));
                Main.getInstance().getProxy().getConsole().sendMessage(new TextComponent(""));
            } else {
                if (this.getDescription().getVersion().endsWith("Pre")) {
                    this.version = version;
                    Main.getInstance().getProxy().getConsole()
                        .sendMessage(new TextComponent("§cSystem §8» §7You are using an §dexperimental build§7!"));
                    Main.getInstance().getProxy().getConsole()
                        .sendMessage(new TextComponent("§cSystem §8» §7Download the latest version (" + version + ") here:"));
                    Main.getInstance().getProxy().getConsole()
                        .sendMessage(new TextComponent("§cSystem §8» §chttps://www.staffcore-bungee.net"));
                    Main.getInstance().getProxy().getConsole().sendMessage(new TextComponent(""));
                } else {
                    this.version = version;
                    Main.getInstance().getProxy().getConsole()
                        .sendMessage(new TextComponent("§cSystem §8» §7You are using an §coutdated build§7!"));
                    Main.getInstance().getProxy().getConsole()
                        .sendMessage(new TextComponent("§cSystem §8» §7Download the latest version (" + version + ") here:"));
                    Main.getInstance().getProxy().getConsole()
                        .sendMessage(new TextComponent("§cSystem §8» §chttps://www.staffcore-bungee.net"));
    ...
    private void setupMySQL() {
        ...
        try {
            ...
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_activitydb(id int(11) NOT NULL AUTO_INCREMENT, type varchar(255) NOT NULL, uuid varchar(36) NOT NULL, "
                    +
            ...
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_playerdb(id INT(6) AUTO_INCREMENT UNIQUE, UUID VARCHAR(255), PLAYERNAME VARCHAR(255), "
                    +
            ...
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_sessionsdb(id INT(6) AUTO_INCREMENT UNIQUE, SESSION_ID VARCHAR(255), UUID VARCHAR(255), SESSION_START LONG, "
                    +
            ...
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_settings(id INT(6) AUTO_INCREMENT UNIQUE, SETTING VARCHAR(255), VALUE VARCHAR(500), EXPECTED_INPUT VARCHAR(255))");

            // PunishmentSystem Reason Management
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_reasonsdb(id INT(6) AUTO_INCREMENT UNIQUE, TYPE VARCHAR(255), NAME VARCHAR(500), BAN_LENGTH LONG, ADMIN_BAN BOOLEAN)");
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_reportreasonsdb(id INT(6) AUTO_INCREMENT UNIQUE, TYPE VARCHAR(255), NAME VARCHAR(500))");

            // BanSystem Banregister
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_bansdb(id INT(6) AUTO_INCREMENT UNIQUE, BAN_ID VARCHAR(35), BANNED_UUID VARCHAR(255), TEAM_UUID VARCHAR(255), REASON VARCHAR(255), BAN_END LONG)");
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_ipbansdb(id INT(6) AUTO_INCREMENT UNIQUE, BANNED_UUID VARCHAR(255), IP_ADDRESS VARCHAR(255), TEAM_UUID VARCHAR(255), BAN_END LONG)");

            // MuteSystem Muteregister
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_mutesdb(id INT(6) AUTO_INCREMENT UNIQUE, MUTE_ID VARCHAR(35), MUTED_UUID VARCHAR(255), TEAM_UUID VARCHAR(255), REASON VARCHAR(255), MUTE_END LONG)");

            // WarnSystem Warnregister
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_warnsdb(id INT(6) AUTO_INCREMENT UNIQUE, WARNED_UUID VARCHAR(255), TEAM_UUID VARCHAR(255), REASON VARCHAR(255), WARNED_AT LONG, SUB_SERVER VARCHAR(255) NOT NULL DEFAULT 'Offline')");

            // Punishment-History
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_punishmentsdb(id INT(6) AUTO_INCREMENT UNIQUE, TYPE VARCHAR(255), PUNISH_ID VARCHAR(35), UUID VARCHAR(255), TEAM_UUID VARCHAR(255), REASON VARCHAR(255), "
                    +
            ...
            // WatchList
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_watchlistdb(id INT(6) AUTO_INCREMENT UNIQUE, UUID VARCHAR(255), TEAM_UUID VARCHAR(255), INSERTED_AT LONG)");

            // ReportSystem
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_reportsdb(id INT(6) AUTO_INCREMENT UNIQUE, TYPE VARCHAR(255), UUID VARCHAR(255), REPORTER_UUID VARCHAR(255), REASON VARCHAR(255), "
                    + "TEAM_UUID VARCHAR(255), STATUS INT(6), CREATED_AT LONG, UPDATED_AT LONG)");

            // Swearing ChatFilter
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_swearingdb(id INT(6) AUTO_INCREMENT UNIQUE, WORD VARCHAR(255), ADDED_AT LONG)");

            // Violationlevel System
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_violationleveldb(id INT(6) AUTO_INCREMENT UNIQUE, UUID VARCHAR(255), VL INT(6))");
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_violationresetdb(id INT(6) AUTO_INCREMENT UNIQUE, UUID VARCHAR(255), NEXT_RESET LONG)");

            // Blacklist System
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCore_blacklistdb(id INT(6) AUTO_INCREMENT UNIQUE, USERNAME VARCHAR(255), ADDED_AT LONG, ADDED_BY VARCHAR(255))");
            ...
            // StaffCoreUI Tables
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCoreUI_Accounts(account_id int(11) NOT NULL AUTO_INCREMENT, username varchar(16) NOT NULL, password varchar(255) NOT NULL, "
                    +
                    "groupid int(6) NOT NULL, uuid varchar(36) DEFAULT NULL, last_login mediumtext NOT NULL, UNIQUE KEY account_id (account_id))");
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCoreUI_Groups(group_id int(11) NOT NULL AUTO_INCREMENT, group_name varchar(255) NOT NULL, group_badge varchar(500) NOT NULL, "
                    + "group_priority int(6) NOT NULL, UNIQUE KEY group_id (group_id))");
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCoreUI_Permissions(id int(11) NOT NULL AUTO_INCREMENT, group_id int(6) NOT NULL, permission_id int(6) NOT NULL, UNIQUE KEY id (id))");
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCoreUI_PublicAccess(id int(11) NOT NULL AUTO_INCREMENT, type varchar(255) NOT NULL, parameter varchar(255) NOT NULL, "
                    + "accessable tinyint(1) NOT NULL DEFAULT 0, PRIMARY KEY (id))");
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCoreUI_Sync(id int(11) NOT NULL AUTO_INCREMENT, TYPE varchar(255) NOT NULL, PROCESS text NOT NULL, PRIMARY KEY (id))");
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCoreUI_Sync_OnJoin(id int(11) NOT NULL AUTO_INCREMENT, USERNAME varchar(16) NOT NULL, TYPE varchar(255) NOT NULL, "
                    + "PROCESS text NOT NULL, PRIMARY KEY (id))");
            mysql.update(
                "CREATE TABLE IF NOT EXISTS StaffCoreUI_UserSettings(id int(11) NOT NULL AUTO_INCREMENT, account_id int(11) NOT NULL, lang varchar(50) NOT NULL DEFAULT 'en_US', "
            ...
            Main.getInstance().getProxy().getConsole()
                .sendMessage(new TextComponent("§cSystem §8(§7MySQL§8) §8- §aSuccessfully §7created the database §atables"));
            Main.getInstance().getProxy().getConsole().sendMessage(new TextComponent(""));

        } catch (IOException e) {
            Main.getInstance().getProxy().getConsole()
                .sendMessage(new TextComponent("§cSystem §8(§7MySQL§8) §8- §cFailed to §7create the database §ctables"));
            Main.getInstance().getProxy().getConsole().sendMessage(new TextComponent(""));
        }
    ...
    private void loadConfigs() {
        ...
        if (!chatfilter.exists()) {
            ...
            try {
                ...
                configcfg.set("ChatFilter.Advertisement-Whitelist",
                    Arrays.asList("yourserver.com", "ts.yourserver.com", "discord.yourserver.com", "forum.yourserver.com",
                        "www.staffcore-bungee.net"));
                configcfg.set("ChatFilter.Blocked-Domains.ccTLD",
                    Arrays.asList(
                        ".ac", ".ad", ".ae", ".af", ".ag", ".ai", ".al", ".am", ".an", ".ao", ".aq", ".ar", ".as", ".asia", ".at", ".au",
                        ".aw", ".ax",
                        ".az", ".ba", ".bb", ".bd", ".be", ".bf", ".bg", ".bh", ".bi", ".bj", ".bm", ".bn", ".bo", ".br", ".bs", ".bt",
                        ".bv", ".bw",
                        ".by", ".bz", ".ca", ".cc", ".cd", ".cf", ".cg", ".ch", ".ci", ".ck", ".cl", ".cm", ".cn", ".co", ".cr", ".cs",
                        ".cu", ".cv",
                        ".cx", ".cy", ".cz", ".de", ".dj", ".dk", ".dm", ".do", ".dz", ".ec", ".ee", ".eg", ".eh", ".er", ".es", ".et",
                        ".eu", ".fi",
                        ".fj", ".fk", ".fm", ".fo", ".fr", ".ga", ".gb", ".gd", ".ge", ".gf", ".gg", ".gh", ".gi", ".gl", ".gm", ".gn",
                        ".gp", ".gq",
                        ".gr", ".gs", ".gt", ".gu", ".gw", ".gy", ".hk", ".hm", ".hn", ".hr", ".ht", ".hu", ".id", ".ie", ".il", ".im",
                        ".in", ".io",
                        ".iq", ".ir", ".is", ".it", ".je", ".jm", ".jo", ".jp", ".ke", ".kg", ".kh", ".ki", ".km", ".kn", ".ko", ".kp",
                        ".kr", ".kw",
                        ".ky", ".kz", ".la", ".lb", ".lc", ".li", ".lk", ".lr", ".ls", ".lt", ".lu", ".lv", ".ly", ".ma", ".mc", ".md",
                        ".mg", ".mh",
                        ".mk", ".ml", ".mm", ".mn", ".mo", ".mp", ".mq", ".mr", ".ms", ".mt", ".mu", ".mv", ".mw", ".mx", ".my", ".na",
                        ".nc", ".ne",
                        ".nf", ".ng", ".ni", ".nl", ".no", ".np", ".nr", ".nu", ".nz", ".om", ".pa", ".pe", ".pf", ".pg", ".ph", ".pk",
                        ".pl", ".pm",
                        ".pn", ".pr", ".ps", ".pt", ".pw", ".py", ".qa", ".re", ".ro", ".ru", ".rw", ".sa", ".sb", ".sc", ".sd", ".se",
                        ".sg", ".sh",
                        ".si", ".sj", ".sk", ".sl", ".sm", ".sn", ".so", ".sr", ".st", ".su", ".sv", ".sy", ".sz", ".tc", ".td", ".tf",
                        ".tg", ".th",
                        ".tj", ".tk", ".tm", ".tn", ".to", ".tp", ".tr", ".tt", ".tv", ".tw", ".tz", ".ua", ".ug", ".uk", ".um", ".us",
                        ".uy", ".uz",
                        ...
                        "(.)tc", "(.)td", "(.)tf", "(.)tg", "(.)th",
                        "(.)tj", "(.)tk", "(.)tm", "(.)tn", "(.)to", "(.)tp", "(.)tr", "(.)tt", "(.)tv", "(.)tw", "(.)tz", "(.)ua", "(.)ug",
                        "(.)uk", "(.)um", "(.)us", "(.)uy", "(.)uz",
                        "(.)va", "(.)vc", "(.)ve", "(.)vg", "(.)vi", "(.)vn", "(.)vu", "(.)wf", "(.)ws", "(.)ye", "(.)yt", "(.)yu", "(.)za",
                        "(.)zm", "(.)zw",
                        "[.]ac", "[.]ad", "[.]ae", "[.]af", "[.]ag", "[.]ai", "[.]al", "[.]am", "[.]an", "[.]ao", "[.]aq", "[.]ar", "[.]as",
                        "[.]asia", "[.]at", "[.]au", "[.]aw", "[.]ax",
                        "[.]az", "[.]ba", "[.]bb", "[.]bd", "[.]be", "[.]bf", "[.]bg", "[.]bh", "[.]bi", "[.]bj", "[.]bm", "[.]bn", "[.]bo",
                ...
                configcfg.set("ChatFilter.Blocked-Domains.gTLD",
                    Arrays.asList(
                        ".edu", ".mil", ".com", ".jobs", ".org", ".name", ".travel", ".info", ".biz", ".mobi", ".int", ".gov", ".coop",
                        ".museum", ".pro", ".aero", ".post",
                        "(.)edu", "(.)mil", "(.)com", "(.)jobs", "(.)org", "(.)name", "(.)travel", "(.)info", "(.)biz", "(.)mobi", "(.)int",
                        "(.)gov", "(.)coop", "(.)museum", "(.)pro", "(.)aero", "(.)post",
                        "[.]edu", "[.]mil", "[.]com", "[.]jobs", "[.]org", "[.]name", "[.]travel", "[.]info", "[.]biz", "[.]mobi", "[.]int",
                        "[.]gov", "[.]coop", "[.]museum", "[.]pro", "[.]aero", "[.]post"
                    ));
        ...
        Main.getInstance().getProxy().getConsole().sendMessage(new TextComponent(""));
        Main.getInstance().getProxy().getConsole()
            .sendMessage(new TextComponent("§cSystem §8» Fetching... (§eTranslations from LacoDev Services§8)"));
        Main.getInstance().getProxy().getConsole().sendMessage(new TextComponent(""));
